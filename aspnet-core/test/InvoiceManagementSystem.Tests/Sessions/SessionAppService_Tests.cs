using InvoiceManagementSystem.Sessions;
using Shouldly;
using System.Threading.Tasks;
using Xunit;

namespace InvoiceManagementSystem.Tests.Sessions;

public class SessionAppService_Tests : InvoiceManagementSystemTestBase
{
