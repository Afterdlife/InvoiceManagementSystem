...
public abstract class InvoiceManagementSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static InvoiceManagementSystemWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(InvoiceManagementSystemWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<InvoiceManagementSystemDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<InvoiceManagementSystemDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<InvoiceManagementSystemDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<InvoiceManagementSystemDbContext, Task<T>> func)
    {
        T result;
