...
namespace InvoiceManagementSystem.EntityFrameworkCore.Seed.Host;
...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = InvoiceManagementSystemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(InvoiceManagementSystemDbContext context)
    {
        _context = context;
    }
